# 1 ".././main.c"
# 1 "c:\\users\\ranul\\Documents\\Atmel Studio\\7.0\\Tutorial\\Tutorial\\Debug//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 ".././main.c"
# 9 ".././main.c"
...
int main(void)
{
 ...
 (*(volatile uint8_t *)((0x04) + 0x20)) |= 0b00100000;
...
void blink13(){
 (*(volatile uint8_t *)((0x05) + 0x20))= 0b00100000;
 _delay_ms(1000);
 (*(volatile uint8_t *)((0x05) + 0x20))= 0b00000000;
 _delay_ms(1000);
}
...
void blink13Advanced(){
 ...
 (*(volatile uint8_t *)((0x05) + 0x20))= high;
 _delay_ms(1000);
 (*(volatile uint8_t *)((0x05) + 0x20))= low;
 _delay_ms(1000);
}
