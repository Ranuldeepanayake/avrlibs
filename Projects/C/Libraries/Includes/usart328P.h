...
void setUsartLed(int toggle);	//Enables or disables USART LEDs. 0: Off, 1: On. LEDs: RX- PORTD2 and TX- PORTD3.
...
char readChar();	//Return a character set by the receive interrupt.
